...
//*    
    ...
    start = getTimeMilliSec();
    result = API_save_to_binary_file(p1, "Data/saved_data.bin");
    end = getTimeMilliSec();
    if(result == 0){
...
//*    
    ...
    printf("API_cipher()...\n");
    start = getTimeMilliSec();
    result = API_cipher("Data/saved_data.bin", "Data/saved_cipher_data.bin");
    end = getTimeMilliSec();
    if(result == 0){
...
//*    
    ...
    printf("API_decipher()...\n");
    start = getTimeMilliSec();
    result = API_decipher("Data/saved_cipher_data.bin", "Data/saved_decipher_data.bin");
    end = getTimeMilliSec();
    if(result == 0){
...
//*/
    ...
    start = getTimeMilliSec();
    p2 = API_restore_from_binary_file("Data/saved_decipher_data.bin");
    if(p2 == NULL){
...
//*    
    ...
    // Get sorted students
    API_set_sorting_mode(p1,MINIMUM);
    printf("==================================\n");
